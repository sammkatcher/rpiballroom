		...
		infiniteCarousel: function(options)
		{
			...
			var options = $.extend(defaults, options);
				...
				$('.infiniteCarousel_item',obj).each(function(index){
					...
					{
						$(this).append('<span class="helper"></span><img src="'+itemSources[index]+'" />');
				...
				$(obj).append('<div class="ic_left_nav" style="position:absolute;height:690px;cursor:pointer;left:0;width:32px;top:'+(0)+'px;">').append('<div class="ic_right_nav" style="position:absolute;height:690px;cursor:pointer;width:32px;right:0;top:'+(0)+'px;">');
				$('.ic_left_nav',obj).append('<img style="margin-top:'+(heightSource/2-16)+'px;" src="'+o.imagePath+'left.png" />');
				$('.ic_right_nav',obj).append('<img style="margin-top:'+(heightSource/2-16)+'px;" src="'+o.imagePath+'right.png" />');
