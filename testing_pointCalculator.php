...
<?php
  ...
  echo "<a class='btn btn-info btn-ballroom' href='/testing_calculator'>Enter new name</a><br />";
  ...
  echo "<script type='text/javascript' src='testing_pointCalculator.js'></script>";
